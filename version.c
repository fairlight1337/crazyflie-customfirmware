...
const char * V_SLOCAL_REVISION="35+";
const char * V_SREVISION="87bf134a3906+";
const char * V_STAG="";
const char * V_BRANCH="default";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=true;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0x87bf134a;
const uint16_t V_REVISION_1=0x3906;
